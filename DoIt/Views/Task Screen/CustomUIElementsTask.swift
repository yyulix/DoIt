...
final class CustomRoundedTaskButton: UIView {
    private struct UIConstants {
        static let height = 50.0
        static let width = 200.0
    }
    ...
    init(title: String, target: Any? = nil, action: Selector? = nil, width: CGFloat? = UIConstants.width, height: CGFloat? = UIConstants.height, color: UIColor? = UIColor.AppColors.accentColor) {
